...
const storageHandler = {
    saveTask: function(taskID, taskData) { // Modularized this function to make it reusable
        ...
        localStorage.setItem(taskID, JSON.stringify(taskData)) // Saving it as a JSON will make it alot easier to get the key-value pairs
    ...
    loadAllTasks: function() {
        ...
        // I should use a for-loop instead of a conditional While, since I'll be getting every item in localStorage anyways
